...
import { Sun, Droplet, Snowflake, AlertTriangle, Calendar, Shield, CheckCircle, Users, Clock, Award, Zap, Handshake } from 'lucide-react';

export default function BahiaDetail() {
  const prestations = [
    {
    ...
    <div className="min-h-screen bg-white text-foreground">
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm">
        <div className="container flex items-center justify-between py-4">
          ...
          <nav className="hidden md:flex items-center gap-6 flex-1 justify-center">
            <Link href="/piscine">
              <a className="text-[#1a4d7a] hover:text-[#0d2d4a] transition-colors">Piscine</a>
            </Link>
            <Link href="/jardin">
          ...
          <button onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="bg-[#1a4d7a] hover:bg-[#0d2d4a] text-white px-6 py-2 rounded-lg font-semibold ml-auto flex-shrink-0">
            Demander un devis
          </button>
        </div>
      </header>
      ...
      <section className="relative py-20 md:py-32 overflow-hidden">
        <div 
          ...
          style={{
            backgroundImage: "url('https://d2xsxph8kpxj0f.cloudfront.net/310519663574569307/BhXdDjxYcYVuZNHd2akwoe/pack-bahia-piscine-4KnHkPvzRQKvCnBpQJfvRX.webp')"
          }}
        >
