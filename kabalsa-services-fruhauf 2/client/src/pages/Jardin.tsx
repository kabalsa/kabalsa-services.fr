...
import { Wind, Scissors, Sprout, Leaf, AlertTriangle, Calendar, Shield, Droplet, CheckCircle, Users, Clock, Award, FileCheck, Zap, Handshake, Menu, X } from 'lucide-react';
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm">
        <div className="container flex items-center justify-between py-4">
          ...
          <nav className="hidden md:flex items-center gap-6 flex-1 justify-center">
            ...
            <Link href="/jardin">
              <a className="text-[#2d5016] hover:text-[#1f3810] transition-colors font-semibold">Jardin</a>
            </Link>
            <Link href="/nos-packs">
          ...
          <button onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hidden md:block bg-[#2d5016] hover:bg-[#1f3810] text-white px-6 py-2 rounded-lg font-semibold ml-auto flex-shrink-0">
            Demander un devis
          </button>
        </div>
        ...
        {mobileMenuOpen && (
          <nav className="md:hidden bg-white border-t border-gray-200 py-4">
            <div className="container flex flex-col gap-4">
              ...
              <Link href="/jardin">
                <a className="text-[#2d5016] hover:text-[#1f3810] transition-colors block py-2 font-semibold" onClick={() => setMobileMenuOpen(false)}>Jardin</a>
              </Link>
              <Link href="/nos-packs">
              ...
              <button 
                ...
                className="bg-[#2d5016] hover:bg-[#1f3810] text-white px-6 py-2 rounded-lg font-semibold w-full mt-2"
              >
                Demander un devis
              </button>
            </div>
